...
class NuvasaBoxGridFour extends PageBuilderBase
{
    protected $a = 1;
    use RepeaterHelper;
    /**
    ...
    {
       return 'service/nuvasa-grid-04.png';
    }
    ...
    public function frontend_render()
    {
        ...
        $style = <<<HTML
            <style>
                ...
                #nuvasa-box-grid-two-{$random} .desc span {
                    font-weight: 600;
                }
    ...
    {
        return __('Nuvasa Box Grid: 02 (IFRAME)');
    }
    ...
    private function render_slider_markup(int $index)
    {
        ...
        $url_position = $this->get_repeater_field_value('url_position', $index, LanguageHelper::user_lang_slug());

        if($url_position == 'right') {
            $title_order =  "order-1 order-md-2";
            $desc_order =  "order-2 order-md-1";
        } else {
            $title_order =  "order-2 order-md-1";
            $desc_order =  "order-1 order-md-2";
        }

        return <<<HTML
            <div class="row" data-aos-duration="1500" data-aos="fade-up">
                <div class="col-lg-7 col-md-7 col-sm-12 p-0 {$title_order}">
                    <div class="row mt-3">
                        <div class="col-12">
                            <div class="url-hover-overflow">
                                {$url_markup}
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-5 col-md-5 col-sm-12 {$desc_order}">
                    <div class="residential_desc mt-3">
