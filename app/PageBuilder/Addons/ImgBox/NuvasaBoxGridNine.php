...
class NuvasaBoxGridNine extends PageBuilderBase
{
    protected $a = 1;
    use RepeaterHelper;
    /**
    ...
    {
       return 'service/nuvasa-grid-09.png';
    }
    ...
    {
        return __('Nuvasa Box Grid: 07 (image)');
    }
    ...
    private function render_slider_markup(int $index)
    {
        ...
        $mini_image = $this->get_repeater_field_value('mini_image', $index, LanguageHelper::user_lang_slug());
        if(!empty($mini_image['img_alt'])) {
            $mini_image_markup = render_image_markup_by_attachment_id($mini_image,'w-100');
        } else if(!empty($title)) {
            $mini_image_markup = render_image_markup_by_attachment_id($mini_image,'w-100" alt="'.$title);
        } else {
            $mini_image_markup = render_image_markup_by_attachment_id($mini_image,'w-100" alt="'.$section_title);
        }
        ...
        return <<<HTML
            <div class="row gx-0 gx-lg-4">
                ...
                <div class="col-12 col-md-4 px-3 px-lg-4 d-flex flex-column justify-content-between" data-aos-duration="1500" data-aos="fade-up">
