            ...
            <div class="col-lg-12">
                ...
                @if(check_page_permission_by_string('Blogs Manage'))
                 ...
                 @endif
                    ...
                    @endif
                    @if(check_page_permission_by_string('Services') && false)
                    <div class="col-md-3 mt-md-5 mb-3">
                        <div class="card text-dark  mb-3">
                            <div class="dsh-box-style">
                    ...
                    @endif
                    @if(check_page_permission_by_string('Price Plan') && false)
                    <div class="col-md-3 mt-md-5 mb-3">
                        <div class="card text-dark  mb-3">
                            <div class="dsh-box-style">
                    ...
                    @endif
                     @if(check_page_permission_by_string('Case Study') && false)
                    <div class="col-md-3 mt-md-5 mb-3">
                        <div class="card text-dark  mb-3">
                            <div class="dsh-box-style">
