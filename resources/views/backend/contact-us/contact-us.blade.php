...
@section('script')
    ...
    <script>
        $(document).ready(function () {
            ...
            $(document).on('click','#bulk_delete_btn',function (e) {
                ...
                if(allIds != '' && bulkOption == 'delete'){
                    ...
                    $.ajax({
                        'type' : "POST",
                        'url' : "{{route('admin.contact-us.bulk.action')}}",
                        'data' : {
                            _token: "{{csrf_token()}}",
                            ids: allIds
                        },
            ...
            $('#pagination').on('change',function (e) {
                ...
                $.ajax({
                    'type' : "POST",
                    'url' : "{{route('admin.contact-us.pagination')}}"+(search?"/"+search:''),
                    'data' : {
                        _token: "{{csrf_token()}}",
                        pagination: $(this).val()
                    },
        ...
        function donlod(tipe) {
            ...
            window.location = "{{route('admin.contact-us.export')}}/"+tipe+(search?"/"+search:'');
        }
