            ...
            <nav id="main_menu_wrap">
                <ul class="metismenu" id="menu">
                    ...
                    @if(check_page_permission_by_string('Pages Manage'))
                        @foreach(\App\Page::where(['status' => 'publish','microsite'=>null])->get() as $page)
                            <li class="{{active_menu('admin-home/page-builder/dynamic-page/dynamic-page/'.$page->id)}}">
                                @php
                                    if($page->page_builder_status == 'on') {
                                        $route = route('admin.dynamic.page.builder',['dynamic-page',$page->id]);
                                    } else {
                                ...
                                aria-expanded="true">
                                    <i class="ti-write"></i>
                                    <span>{{__($page->title)}} Page</span>
                                </a>
                            </li>
                        @endforeach
                    @endif
                    @if(check_page_permission_by_string('Pages Manage'))
                        @foreach(\App\Microsite::where('status','publish')->get() as $microsite)
                        @php
                            $microId = ['admin-home/menu/microsite/*','admin-home/widgets/*'];
                            foreach(\App\Page::where(['status' => 'publish','microsite'=>$microsite->slug])->get() as $page):
                                $microId[] = 'admin-home/page-builder/dynamic-page/dynamic-page/'.$page->id;
                            endforeach;
                        @endphp
                            <li
                            class="main_dropdown
                            @if(request()->is($microId)) active @endif
                            ">
                                <a href="javascript:void(0)" aria-expanded="true"><i class="ti-write"></i>
                                    <span>{{__($microsite->name)}}</span></a>
                                <ul class="collapse">
                                    {{-- @foreach(\App\Page::where(['status' => 'publish','microsite'=>$microsite->slug])->get() as $page) --}}
                                    @foreach(json_decode(\App\Menu::where(['id' => 18])->first()->content) as $page)
                                        @php
                                            $miniId = ['admin-home/page-builder/dynamic-page/dynamic-page/'.$page->id];
                                            if(!empty($page->children)) {
                                                foreach($page->children as $child):
                                                    if(empty($child->id)){continue;}
                                                    $miniId[] = 'admin-home/page-builder/dynamic-page/dynamic-page/'.$child->id;
                                                endforeach;
                                            }
                                        @endphp
                                        <li class="{{!empty($page->children)?'main_dropdown':''}} @if(request()->is($miniId)) active @endif">
                                            @if(empty($page->children))
                                                <a href="{{route('admin.dynamic.page.builder',['dynamic-page',$page->id])}}"
                                                aria-expanded="true">
                                                    {{__($page->pname)}} Page
                                                </a>
                                            @else
                                                ...
                                                <ul class="collapse">
                                                    ...
                                                    @foreach($page->children as $child)
                                                        <?php if(empty($child->id)){continue;}?>
                                                        <li class="{{active_menu('admin-home/page-builder/dynamic-page/dynamic-page/'.$child->id)}}">
                                                            <a href="{{route('admin.dynamic.page.builder',['dynamic-page',$child->id])}}"
                                                            aria-expanded="true">
                                                                {{__($child->pname)}} Page
                                                            </a>
                                                        </li>
                                    ...
                                    @endforeach
                                    <li class="{{active_menu('admin-home/menu/microsite/'.$microsite->id)}}"><a
                                                href="{{route('admin.menu.index-microsite',$microsite->id)}}">{{__('Default Menu')}}</a></li>
                                    <li class="{{active_menu('admin-home/widgets/'.$microsite->id)}}"><a
                                                href="{{route('admin.widgets',$microsite->id)}}">{{__('Footer Area')}}</a></li>
                                </ul>
                            </li>
                        @endforeach
                    @endif
                    ...
                    <li
                        class="main_dropdown d-none @if(request()->is(['admin-home/newsletter/*','admin-home/newsletter'])) active @endif
                     ">
                    ...
                    @if(check_page_permission_by_string('Pages Manage'))
                        <li
                        class="main_dropdown
                        @if(request()->is(['admin-home/microsite/*','admin-home/microsite'])) active @endif
                        ">
                            <a href="javascript:void(0)" aria-expanded="true"><i class="ti-write"></i>
                                <span>{{__('Microsites')}}</span></a>
                            <ul class="collapse">
                                <li class="{{active_menu('admin-home/microsite')}}"><a
                                            href="{{route('admin.microsite')}}">{{__('All Microsites')}}</a></li>
                                <li class="{{active_menu('admin-home/microsite/new')}}"><a
                                            href="{{route('admin.microsite.new')}}">{{__('Add New Microsite')}}</a></li>
                            </ul>
                        </li>
                    @endif
                    ...
                    @if(check_page_permission_by_string('Pages Manage'))
                        <li
                        class="main_dropdown
                        @if(request()->is(['admin-home/contact-us-home*','admin-home/contact-us'])) active @endif
                        ">
                            <a href="javascript:void(0)" aria-expanded="true"><i class="ti-write"></i>
                                <span>{{__('Contact Form DB')}}</span></a>
                            <ul class="collapse">
                                <li class="{{active_menu('admin-home/contact-us-home')}}"><a
                                            href="{{route('admin.contact-us-home.all')}}">{{__('DB Leads Home')}}</a></li>
                                <li class="{{active_menu('admin-home/contact-us')}}"><a
                                            href="{{route('admin.contact-us.all')}}">{{__('DB Leads The Nove')}}</a></li>
                            </ul>
                        </li>
                    @endif
                    ...
                    @if(check_page_permission_by_string('Video Gallery'))
                        ...
                        @if(request()->is('admin-home/video-gallery/*')) active @endif
                                ">
                            <a href="javascript:void(0)" aria-expanded="true"><i class="ti-write"></i>
                                <span>{{__('File & Video Upload')}}</span></a>
                            <ul class="collapse">
                                <li class="{{active_menu('admin-home/video-gallery/file')}}">
                                    <a href="{{route('admin.video.gallery.file')}}" >{{__('PDF Upload')}}</a>
                                </li>
                                <li class="{{active_menu('admin-home/video-gallery/upload')}}">
                                    <a href="{{route('admin.video.gallery.upload')}}" >{{__('Upload Video')}}</a>
                                </li>
                    ...
                    <li class="main_dropdown
                        ...
                        <ul class="collapse ">
                            ...
                            @if(check_page_permission_by_string('Contact Page Manage'))
                                <li class="main_dropdown
                                 @if(request()->is(['admin-home/contact-page/*','admin-home/page-builder/contact-page'])  ) active @endif">
                                    <a href="javascript:void(0)"
                                       aria-expanded="true">
                            ...
                            @if(check_page_permission_by_string('Feedback Page Manage'))
                                <li class="main_dropdown 
                                d-none @if(request()->is('admin-home/feedback-page/*')  ) active @endif">
                                    <a href="javascript:void(0)"
                                       aria-expanded="true">
                    ...
                    ">
                        ...
                        <ul class="collapse ">
                            @if(check_page_permission_by_string('Topbar Settings'))
                                <li class="d-none {{active_menu('admin-home/appearance-setting/topbar-settings')}}">
                            ...
                            @if(check_page_permission_by_string('Home Variant'))
                                <li class="d-none {{active_menu('admin-home/appearance-setting/navbar-variant/settings')}}">
                                    <a href="{{route('admin.navbar.settings')}}"
                                       aria-expanded="true">
                                        {{__('Navbar Settings')}}
                                    </a>
                                </li>
                                <li class="d-none main_dropdown {{active_menu('admin-home/appearance-setting/home-variant')}}">
                                ...
                                <li class="d-none {{active_menu('admin-home/appearance-setting/footer-settings')}}">
                                ...
                                @if(check_page_permission_by_string('Form Builder'))
                                    <li class="main_dropdown @if(request()->is('admin-home/form-builder/*')) active @endif">
                                        ...
                                        <ul class="collapse">
                                            ...
                                            <li class="{{active_menu('admin-home/form-builder/get-in-touch')}} d-none"><a
                                                        href="{{route('admin.form.builder.get.in.touch')}}">{{__('Get In Touch Form')}}</a></li>
                                            <li class="{{active_menu('admin-home/form-builder/service-query')}} d-none"><a
                                                        href="{{route('admin.form.builder.service.query')}}">{{__('Service Query Form')}}</a></li>
                                            <li class="{{active_menu('admin-home/form-builder/case-study-query')}} d-none"><a
                                                        href="{{route('admin.form.builder.case.study.query')}}">{{__('Case Study Query Form')}}</a></li>
                                            <li class="{{active_menu('admin-home/form-builder/quote-form')}} d-none"><a
                                                        href="{{route('admin.form.builder.quote')}}">{{__('Quote Form')}}</a></li>
                                            <li class="{{active_menu('admin-home/form-builder/order-form')}} d-none"><a
                                            ...
                                            <li class="{{active_menu('admin-home/form-builder/apply-job-form')}} d-none"><a
                                                        href="{{route('admin.form.builder.apply.job.form')}}">{{__('Apply Job Form')}}</a>
                                            </li>
                                            <li class="{{active_menu('admin-home/form-builder/event-attendance')}} d-none"><a
                                                        href="{{route('admin.form.builder.event.attendance.form')}}">{{__('Event Attendance Form')}}</a>
                                            </li>
                                            <li class="{{active_menu('admin-home/form-builder/appoinment-booking')}} d-none"><a
                                                href="{{route('admin.form.builder.appointment.form')}}">{{__('Call Action Query Form')}}</a>
                                            </li>
                                            <li class="{{active_menu('admin-home/form-builder/estimate')}} d-none"><a
...
{{--                            </li>--}}
                            <li class="{{active_menu('admin-home/general-settings/page-settings')}} d-none"><a
                            ...
                            <li class="{{active_menu('admin-home/general-settings/cache-settings')}} d-none"><a
                                        href="{{route('admin.general.cache.settings')}}">{{__('Cache Settings')}}</a>
                            </li>
                            <li class="d-none {{active_menu('admin-home/general-settings/gdpr-settings')}}"><a
                            ...
                            <li class="{{active_menu('admin-home/general-settings/module-settings')}} d-none"><a
                                    href="{{route('admin.general.module.settings')}}">{{__('Module Settings')}}</a>
                            </li>
                            <li class="{{active_menu('admin-home/general-settings/database-upgrade')}} d-none"><a
                                        href="{{route('admin.general.database.upgrade')}}">{{__('Database Upgrade')}}</a>
                            </li>
                            <li class="{{active_menu('admin-home/general-settings/license-setting')}} d-none"><a
