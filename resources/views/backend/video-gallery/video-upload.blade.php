    ...
    <div class="col-lg-12 col-ml-12 padding-bottom-30">
        <div class="row">
            ...
            <div class="col-lg-6 mt-5">
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title">{{__('Video Upload')}}</h4>
                        ...
                        <table class="table table-default" id="all_blog_table">
                            ...
                            @foreach($all_gallery as $data)
                                <tr>
                                    ...
                                    <td>{{$data->title}}</td>
                                    <td>
                                        <x-delete-popover :url="route('admin.video.gallery.deleteUpload',$data->id)"/>
                                        <a href="#"
                                           data-toggle="modal"
                                           ...
                                           data-localfile="{{substr($data->local_file,22)}}"
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{route('admin.video.gallery.new')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label for="title">{{__('Video File')}}</label>
                                <input type="file" name="local_file" class="form-control">
                            </div>
                            <div class="form-group">
    ...
    <script>
        $(document).ready(function () {
            ...
            $(document).on('click','.testimonial_edit_btn',function(){
                ...
                form.find('span#localfile').html(el.data('localfile'));
