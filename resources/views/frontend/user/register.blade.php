...
@section('scripts')
    ...
    <script type="text/javascript" lang="javascript" src="https://cdns.gigya.com/js/gigya.js?apikey=4_PwQegp298aOVpxbvpKMcFg"></script>
    <script>
        ...
        //redirect while register success 
